...
%
        ...
        [xs_est,whts,errs,spec] = lintr_whit_matr2(ys,as_uniq,ias,nas,...
            m,m2,n,k,cov_ep)


        [xs_est2,whts2,errs2,spec2] = lintr_whit_matr(ys,as_cube,...
            m,m2,n,k,cov_ep)
...
%
%
        function [xmean,as2_mean,yback,fracs] = lintr_mean_matr2(ys,as_uniq,ias,nas,m,m2,n)
%
